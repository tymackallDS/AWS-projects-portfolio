...
class CdkappStack(Stack):
    ...
    def __init__(self, scope: Construct, construct_id: str, **kwargs) -> None:
        ...
        # create a vpc with IpAdresses 10.10.0.0/16, a NAT gateway, a public subnet, PRIVATE_WITH_EGRESS subnet and a RDS subnet
        vpc = ec2.Vpc(self, "MyVpc",
            ...
            subnet_configuration = [
                ...
                ec2.SubnetConfiguration(name="PRIVATE_WITH_EGRESS", subnet_type=ec2.SubnetType.PRIVATE_WITH_EGRESS),
                ec2.SubnetConfiguration(name="rds", subnet_type=ec2.SubnetType.PRIVATE_ISOLATED)
            ]
        )
        ...
        cluster = rds.DatabaseCluster(self, "MyDatabase",
            ...
            instance_props={
                #add a vpc to rds instance
                "vpc": vpc,
                #add a security group to rds instance
                "security_groups": [rds_sg],
                #add a private subnet to rds instance
...
##For lab
##add another ec2 instance in another availability zone using code whisper. Configure target groups
##Updated below
########################################################################################################
from aws_cdk import (
    Duration,
